...
{
    [NonSerialized] protected InventoryItemData itemData; // Refrence to the data
    [SerializeField] protected int _itemID = -1;
    [SerializeField] protected int stackSize; // Current stack size - how many of the data do we hav?
